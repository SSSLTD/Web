...
const translations = {
  en: {
    ...
    service_support_desc: 'Emergency maintenance and monitoring services available around the clock.',
  ...
  ar: {
    ...
    service_support_desc: 'خدمات الصيانة والطوارئ والمراقبة متاحة على مدار الساعة.',
